...
<main>
    <form action="" method="POST">
        ...
        <div>
            ...
            <input type="number"  id="priorite" name="priorite" step="1" min="1" value=<?php echo "'" .$tache->getPriorite() ."'"; ?> >
        </div>
        ...
        <div>
            ...
            <select name="statut" id="statut" style="height:50%; margin: 16px 0px;">
                ...
                <option value="Non Débuté" <?php if ($tache->getStatut() === 'Non Débuté') :echo 'selected'; endif; ?> >Non débuté </option>
                <option value="En Cours" <?php if ($tache->getStatut() === 'En Cours') :echo 'selected'; endif; ?> >En Cours</option>
                <option value="Terminé" <?php if ($tache->getStatut() === 'Terminé') :echo 'selected';endif; ?>>Terminé</option>
        ...
        <div>
            ...
            <select name="id_users" id="user">
                <?php foreach ($users as $user) { ?>
                    ...
                    <option value=<?php echo "'" .$user->getId() ."'"; echo ($user->getId() === $tache->id_users) ? 'selected': "" ;?> > <?php echo $user->getPseudo(); ?></option>
        ...
        <div>
            ...
            <input type="submit" value="valider" name='update' <?php if (isset($_GET['delete'])) :echo "style='display:none;'"; endif; ?> >

        </div>
    </form>

    <?php if (isset($_GET['delete']) && $_GET['delete'] == $tache->getId()) {
...
<main>
    <form action="" method="POST">
        ...
        <div>
            <label for="priorite">Priorité:</label>
            <input type="number" id="priorite" name="priorite" value='' step="1" min="1">
        </div>
